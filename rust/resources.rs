...
examples/book:
    ...
    Rust By Examples: (its a book) (i used this one to learn rust it has better documentations than the book)
        https://doc.rust-lang.org/stable/rust-by-example/

    RustLaings Course: (Code And Learn)
...
rusty youtube Channels:
    ...
    TanTan: (Rust in Games Pretty Xciting)
        https://www.youtube.com/channel/UChl_NKOs1qqh_x7yJfaDpDw
